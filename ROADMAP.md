...
> **最近一次状态刷新**：2026-08-03 — D4.15 ShopItemManager SEND_SHOPITEM_USEDINFO wire 1:1 lock（7 new tests：struct 3410B + size helper + serialize category/protocol + trim + post-release empty），D4.14 UsedShopItem 数据面 +11，D4.13 tick/expire +13，D5.1 agent_murimnet forward +7，D4.12 数据平面 +25；ShopItemManager 56/56 PASS。
