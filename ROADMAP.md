...
> **最近一次状态刷新**：2026-08-01 — D4.11 ItemManager 金钱 helper 修正为 legacy MAXMONEY=0xFFFFFFFF 裁剪语义（2 new tests）；D5 MurimNet 139 tests 已锁；D6.1 DropTableRegistry 31 tests 已锁；HackShield manager 19 tests + nprotect manager 24 tests 由 dormant build 激活；Debug 全量 6804 tests PASS（Login E2E 波动项经 CTest 单项重试通过）。
