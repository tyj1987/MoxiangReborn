...
> **最近一次状态刷新**：2026-08-03 — D4.12 ShopItemManager 1:1 port（SHOPITEMBASE/SHOPITEMWITHTIME/MOVEDATA 三种 packed struct + 5 dup 计数器 + using-table/move-table CRUD + init/release，25 tests 全锁 legacy CommonStruct.h pack(1) 布局）；Debug 全量 6804+ tests PASS。
