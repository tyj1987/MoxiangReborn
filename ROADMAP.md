...
> **最近一次状态刷新**：2026-08-01 — D4.9 `ItemSlot` / `InventorySlot` 核心状态机 1:1 锁定（40 tests）；T2 `ITEM_TOTALINFO` / `SEND_HERO_TOTALINFO` 当前 legacy 默认布局已修正；Debug 全量 6800 tests PASS（Login E2E 波动项经 CTest 单项重试通过）。
