...
> **最近一次状态刷新**：2026-08-03 — D4.18 ShopItemManager 5个 legacy data-plane helpers（11 new tests：find_using_item_by_icon_idx_mutable / add_shop_item_use 零键+重键拒绝+全字段保留 / rename_move_point 未知键拒绝+MAX_SAVEDMOVE_NAME-1 截断+NUL 终止 / release_move_points 只清 move-points 保留 using-items+dup / get_saved_mp_num 等价 move_point_count，ShopItemManager 88/88 PASS。
