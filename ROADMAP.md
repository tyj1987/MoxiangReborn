...
> **最近一次状态刷新**：2026-08-03 — D4.16 ShopItemManager SEND_SHOPITEM_INFO + SEND_MOVEDATA_INFO wire 1:1 lock（10 new tests），D4.15 SEND_SHOPITEM_USEDINFO wire +7，D4.14 UsedShopItem 数据面 +11，D4.13 tick/expire +13，D5.1 agent_murimnet forward +7，D4.12 数据平面 +25；ShopItemManager 66/66 PASS，ShopItemManager wire 层完整。
