...
| T3 玩法数值 1:1 | **PARTIAL** | D1 SkillList ✓ D2 BattleFactory ✓ D3 QuestManager runtime bridge ✓ D5 MurimNet ✓ D6.1-D6.7 ✓; D4 商城待 |
...
### Phase D - 玩法/数值 1:1
- [x] D1 SkillList + D2 BattleFactory + D3 QuestManager runtime bridge + D5 MurimNet + D6.1-D6.7
...
| P1 | **D4 商城 UseShopItem 真逻辑** | D3 桥已落 (commit 9512a082), 商城 stub | UseShopItem + CheckEndTime legacy path |
