...
> **最近一次状态刷新**：2026-08-01 — D4.10 Pyoguk 运行时容量统一为 legacy 5×30=150 格（2 new tests）；D4.9 `ItemSlot` / `InventorySlot` 核心状态机已锁定；Debug 全量 6802 tests PASS（Login E2E 波动项经 CTest 单项重试通过）。
