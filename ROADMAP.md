...
> **最近一次状态刷新**：2026-08-01 — D4.11 ItemManager 金钱 helper 修正为 legacy MAXMONEY=0xFFFFFFFF 裁剪语义（2 new tests）；D4.9-D4.10 物品槽/仓库容量已锁定；Debug 全量 6804 tests PASS（Login E2E 波动项经 CTest 单项重试通过）。
