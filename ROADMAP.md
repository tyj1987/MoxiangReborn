...
> **最近一次状态刷新**：2026-08-03 — D4.17 ShopItemManager AddMovePoint ValidCount 门（11 new tests：4 incantation icons 各自 double capacity 10→20；add_move_point >= gate；delete incantation 恢复 capacity），ShopItemManager 77/77 PASS。
