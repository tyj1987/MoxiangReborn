...
| Drag-drop rendering wiring | ⏳ future | cIcon sprite + dispatch (data model is 6.11) |
| 194 个 legacy 对话框（Guild*/Inventory*）| ⏳ future | 1:1 端口 (33/202 = 16.3% done: 5 base+33 dialog+5 subcontrol; **P2-12 突破 10% + 15% + 16% 三里程碑**; **P2-12 roadmap** 在 `docs/P2-12_DIALOGS_ROADMAP.md` + **R-9** 矩阵 audit 跟 drawBox deferred) |
