...
| Drag-drop rendering wiring | ⏳ future | cIcon sprite + dispatch (data model is 6.11) |
| 194 个 legacy 对话框（Guild*/Inventory*）| ⏳ future | 1:1 端口 (49/202 = 24.3% done: 5 base+49 dialog+10 subcontrol; **P2-12 突破 10% + 15% + 20% + 21% + 22% + 23% + 24% 七里程碑**; **P2-12 roadmap** 在 `docs/P2-12_DIALOGS_ROADMAP.md` + **R-9** 矩阵 audit 跟 drawBox deferred) |
