...
| Phase 1 §7 登录/角色/显示 | PENDING (UI fix 在 §5 commit 10365b7a 已包含) | — | 老客户端 UI 修复,modern 端无需独立改动 |
...
- **Phase 1 §7.2 登录错误矩阵 14 项** — 多数是 integration test,每项 1-2 hours
- **Phase 1 §7.3 角色流程 9 项** — 大部分 CTest 已有,补漏 + 真数据绑定
