...
| `EVID-20260825-full-ctest` | `da929e21` | local Debug build | `ctest -C Debug --test-dir modern/build --output-on-failure` | 12,132 registered; 12,132 passed; 19 tests skip for explicit missing/optional fixtures. BGM playback now uses Media Foundation/XAudio2; this is still not an RC gate because the skipped runtime/resource gates and human path remain open. |
