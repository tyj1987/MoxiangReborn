...
#include "stdafx.h"
//#include <windows.h>
// Note: legacy Strclass.cpp had `#include <atlbase.h>` here, but it was
// never actually referenced (no CString / AtlThrow / ATL symbol usage
// in this TU). ATL headers are not installed in this environment, so
// the include is removed. Tracked in docs/KNOWN_BUGS.md.
//#include <limits.h>
//#include <tchar.h>
#include "stdio.h"
#include "strclass.h"
