...
// Note: BaseNetworkDll.cpp needs UNICODE because the COM
// StringFromGUID2/GUID-to-string APIs require wide-character buffers.
// The legacy vcproj did not set CharacterSet explicitly, but the
// `#define UNICODE` at the top of this TU forces this file into the
// Unicode TCHAR model while the rest of the project stays MBCS.
// Modern MSVC rejects this mix under /Zc:strictStrings — we relax
// it via CMakeLists.txt /Zc:strictStrings-. Tracked in
// docs/KNOWN_BUGS.md (Bug C-9).
