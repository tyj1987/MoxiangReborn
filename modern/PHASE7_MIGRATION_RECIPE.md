...
| `[Server]Map` §           | **RETRACTED** (7.5) | VS17 / x86 | `modern/scripts/build_map.py` | *(no EXE produced)* | **❌ RETRACTED 2026-07-08**: 三次独立重建均报 1319 errors（C2447 626 + C2065 373 + C2039 313 + C2146 6 + C2660 1）。原 commit 4b78083 的 "0 errors / 3,857,920 bytes" 声明系伪造（详见 `docs/KNOWN_BUGS.md` Bug E-1）。等 Phase 7.5c 真实 gate 完成后回填。 |
