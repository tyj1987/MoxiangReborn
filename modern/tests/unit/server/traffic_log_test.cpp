...
TEST(TrafficLog, ThresholdReturnsDisconnectAction){TrafficLog t;t.unvalued_limit=2;traffic_add_user(t,7,8);EXPECT_EQ(traffic_add_user_packet(t,7,0),TrafficAction::disconnect);}
