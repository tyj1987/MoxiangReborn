...
TEST(WireFormatCoverage, LocksCurrentCoverageCount) {
    ...
    EXPECT_TRUE(by_cat.count(5)) << "cat=5 (Item) golden lost (M19)";
    EXPECT_TRUE(by_cat.count(9)) << "cat=9 (Mugong) golden lost (M20)";
    EXPECT_TRUE(by_cat.count(2)) << "cat=2 (PowerUp) golden lost (M21)";
    EXPECT_TRUE(by_cat.count(1)) << "cat=1 (Server) golden lost (M22)";
    ...
    EXPECT_TRUE(by_cat.count(28)) << "cat=28 (Exchange) golden lost (M26)";
    EXPECT_TRUE(by_cat.count(10)) << "cat=10 (AuctionBoard) golden lost (M27)";
    EXPECT_TRUE(by_cat.count(58)) << "cat=58 (Wanted) golden lost (M28)";
    EXPECT_TRUE(by_cat.count(71)) << "cat=71 (Weather) golden lost (M29)";
    EXPECT_TRUE(by_cat.count(12)) << "cat=12 (Quick) golden lost (M30)";
    EXPECT_TRUE(by_cat.count(33)) << "cat=33 (Friend) golden lost (M31)";
    EXPECT_TRUE(by_cat.count(37)) << "cat=37 (Npc) golden lost (M32)";
    EXPECT_TRUE(by_cat.count(39)) << "cat=39 (Quest) golden lost (M33)";
    EXPECT_TRUE(by_cat.count(30)) << "cat=30 (Pyoguk) golden lost (M34)";
    EXPECT_TRUE(by_cat.count(62)) << "cat=62 (Guild) golden lost (M35)";
    EXPECT_TRUE(by_cat.count(72)) << "cat=72 (Pet) golden lost (M36)";
    EXPECT_TRUE(by_cat.count(69)) << "cat=69 (SiegeWar) golden lost (M37)";
    EXPECT_TRUE(by_cat.count(15)) << "cat=15 (PeaceWarMode) golden lost (M38)";
    EXPECT_TRUE(by_cat.count(23)) << "cat=23 (KyungGong) golden lost (M39)";
    EXPECT_TRUE(by_cat.count(29)) << "cat=29 (StreetStall) golden lost (M40)";
    EXPECT_TRUE(by_cat.count(65)) << "cat=65 (PartyWar) golden lost (M41)";
    EXPECT_TRUE(by_cat.count(17)) << "cat=17 (Auction) golden lost (M42)";
    EXPECT_TRUE(by_cat.count(21)) << "cat=21 (Munpa) golden lost (M43)";
    EXPECT_TRUE(by_cat.count(41)) << "cat=41 (Pk) golden lost (M44)";
    EXPECT_TRUE(by_cat.count(64)) << "cat=64 (Note) golden lost (M45)";
    EXPECT_TRUE(by_cat.count(20)) << "cat=20 (Tactic) golden lost (M46)";
    EXPECT_TRUE(by_cat.count(24)) << "cat=24 (SimBub) golden lost (M47)";
    EXPECT_TRUE(by_cat.count(32)) << "cat=32 (CharRevive) golden lost (M48)";
    EXPECT_TRUE(by_cat.count(70)) << "cat=70 (SiegeWar_Profit) golden lost (M49)";
    EXPECT_TRUE(by_cat.count(60)) << "cat=60 (Suryun) golden lost (M50)";
    EXPECT_TRUE(by_cat.count(31)) << "cat=31 (Battle) golden lost (M51)";
    EXPECT_TRUE(by_cat.count(3)) << "cat=3 (Char) golden lost (M52)";
    EXPECT_TRUE(by_cat.count(13)) << "cat=13 (PackedData) golden lost (M53)";
    EXPECT_TRUE(by_cat.count(16)) << "cat=16 (UngiJosik) golden lost (M54)";
    EXPECT_TRUE(by_cat.count(19)) << "cat=19 (Signal) golden lost (M55)";
    EXPECT_TRUE(by_cat.count(18)) << "cat=18 (AutoPatch) golden lost (M56)";
    EXPECT_TRUE(by_cat.count(38)) << "cat=38 (Murimnet) golden lost (M57)";
    EXPECT_TRUE(by_cat.count(34)) << "cat=34 (BossMonster) golden lost (M58)";
    EXPECT_TRUE(by_cat.count(35)) << "cat=35 (Monster) golden lost (M59)";
    EXPECT_TRUE(by_cat.count(36)) << "cat=36 (Option) golden lost (M60)";
    EXPECT_TRUE(by_cat.count(25)) << "cat=25 (MornitorTool) golden lost (M61)";
    EXPECT_TRUE(by_cat.count(26)) << "cat=26 (MornitorServer) golden lost (M62)";
    EXPECT_TRUE(by_cat.count(27)) << "cat=27 (MornitorMapServer) golden lost (M63)";
    EXPECT_TRUE(by_cat.count(40)) << "cat=40 (Debug) golden lost (M64)";
    EXPECT_TRUE(by_cat.count(42)) << "cat=42 (HackCheck) golden lost (M65)";
    EXPECT_TRUE(by_cat.count(43)) << "cat=43 (RmToolConnect) golden lost (M66)";
    EXPECT_TRUE(by_cat.count(53)) << "cat=53 (Journal) golden lost (M67)";
    EXPECT_TRUE(by_cat.count(55)) << "cat=55 (SocietyAct) golden lost (M68)";
    EXPECT_TRUE(by_cat.count(57)) << "cat=57 (GuildFieldWar) golden lost (M69)";
    EXPECT_TRUE(by_cat.count(63)) << "cat=63 (SiegeWarCastle) golden lost (M70)";
    EXPECT_TRUE(by_cat.count(61)) << "cat=61 (Jackpot) golden lost (M71)";
    EXPECT_TRUE(by_cat.count(67)) << "cat=67 (HackShield) golden lost (M72)";
    EXPECT_TRUE(by_cat.count(68)) << "cat=68 (RmToolPet) golden lost (M73)";
    EXPECT_TRUE(by_cat.count(73)) << "cat=73 (ItemExt) golden lost (M74)";
    EXPECT_TRUE(by_cat.count(44)) << "cat=44 (RmToolUser) golden lost (M75)";
    EXPECT_TRUE(by_cat.count(45)) << "cat=45 (RmToolMunpa) golden lost (M76)";
    EXPECT_TRUE(by_cat.count(46)) << "cat=46 (RmToolGameLog) golden lost (M77)";
    EXPECT_TRUE(by_cat.count(47)) << "cat=47 (RmToolOperLog) golden lost (M78)";
    EXPECT_TRUE(by_cat.count(48)) << "cat=48 (RmToolStatistics) golden lost (M79)";
    EXPECT_TRUE(by_cat.count(49)) << "cat=49 (RmToolAdmin) golden lost (M80)";
