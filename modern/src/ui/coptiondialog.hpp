...
private:
    ...
    cCheckBox*     m_cbNoDeal = nullptr; cCheckBox* m_cbNoParty = nullptr;
    cCheckBox*     m_cbNoFriend = nullptr; cCheckBox* m_cbNoChatting = nullptr;
    cCheckBox*     m_cbNoWhisper = nullptr; cCheckBox* m_cbNoBalloon = nullptr;
    cCheckBox*     m_cbAutoHide = nullptr; cCheckBox* m_cbNoSystemMsg = nullptr;
    cCheckBox*     m_cbNoItemMsg = nullptr; cCheckBox* m_cbShadowHero = nullptr;
    cCheckBox*     m_cbShadowMonster = nullptr; cCheckBox* m_cbShadowOthers = nullptr;
    cCheckBox*     m_cbAutoControl = nullptr; cCheckBox* m_cbBgmSound = nullptr;
    cCheckBox*     m_cbEnvSound = nullptr; cGuageBar* m_gbGamma = nullptr;
    cGuageBar* m_gbSight = nullptr; cGuageBar* m_gbBgmSound = nullptr;
    cGuageBar* m_gbEnvSound = nullptr; cPushupButton* m_pbChatMode = nullptr;
    cPushupButton* m_pbMacroMode = nullptr; cPushupButton* m_pbBasicGraphic = nullptr;
    cPushupButton* m_pbDownGraphic = nullptr; cPushupButton* m_pbBasicEffect = nullptr;
