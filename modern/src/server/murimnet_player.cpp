...
bool MurimNetPlayer::init(const MurimNetPlayerInfo& info)noexcept{if(info.player_id==0)return false;m_info=info;m_roomState={};m_roomState.id=info.player_id;m_connected=true;return true;}
